  ...
  <section class="conversation-screen" aria-label="对话">
    ...
    <section class="voice-dock">
      <section class="quick-actions" aria-label="语音操作">
        <button class="voice-chip" type="button" :disabled="isListening" @click="listenAndTranslateOnce('source')">
          <span>我说</span>
        ...
        <button
          ...
          aria-label="开始语音翻译"
          @click="listenAndTranslateOnce('source')"
        >
          <span class="mic-symbol"></span>
        </button>
        <button class="voice-chip" type="button" :disabled="isListening" @click="listenAndTranslateOnce('target')">
          <span>对方说</span>
